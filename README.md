...
## Note from Eric Leung
- I used Poetry and Python 3.10 for the setup 
- The API can be run and tested with the Makefile
- In the `/company/check_discrepancy` endpoint, I assume we would get the pdf file name (e.g. `financellc.pdf`) and the company name (e.g. `FinanceLLC`) as arguments
- I have commented in some places about the things that I was unsure about in the code (e.g. `src/models/company/company_info.py`)
